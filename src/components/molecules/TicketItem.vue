...
<template>
    <div ref="ani" @mousemove="(e) => handleCard(e, 5)" @mouseleave="e => handleLeave(e)"
        class="flex w-[700px] h-[250px] drop-shadow-xl">
        ...
        <div class="flex flex-col w-full h-full rounded-xl overflow-hidden pointer-events-none">
            ...
            <div class="flex gap-4 h-full w-full p-4 bg-white overflow-hidden">
                <img src="../../assets/poke.png" class="w-32 h-full object-cover" alt="プロフィール写真">
                <div class="relative flex flex-col justify-around w-full h-full bg-[url('/src/assets/map.png')] bg-no-repeat bg-[-420px_-120px] bg-[length:200%] ">
                    <svg class="absolute top-0 left-0" width="100%" height="100%">
                        <path d="M140,148 A 80,80 0 0 1 208,51" stroke="red" stroke-width="2" fill="none" stroke-dasharray="5,5" stroke-linecap="round"/>
                    </svg>
        ...
        <div class="relative flex flex-col justify-between items-center w-[200px] h-full bg-white overflow-hidden rounded-xl pointer-events-none">
            <div class="relative flex items-center h-[64px] w-full px-4 bg-blue-400">
                <div class="absolute left-0 top-0 h-full w-0  border-l border-dotted border-white"></div>
                <div class="border border-orange-400 w-full">contents</div>
            </div>
            <div class="relative flex flex-col justify-between items-center gap-2 px-4 py-2 h-full">
